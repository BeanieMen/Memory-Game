...
var Block_17_mouse_over = false
var Block_18_mouse_over = false
var Block_19_mouse_over = false
var Block_20_mouse_over = false
var Block_21_mouse_over = false
var Block_22_mouse_over = false
var Block_23_mouse_over = false
var Block_24_mouse_over = false
var Block_25_mouse_over = false
...
func _on_GameStart_timeout():
	...
	match Row_4:
		...
		2:
			$TimeColored.start()
			$Block_17/Block_17_spr.texture = load("res://Assests/Black.png")
			$Block_17/Block_17_spr.isTarget = true
		3:
			$TimeColored.start()
			$Block_18/Block_18_spr.texture = load("res://Assests/Black.png")
			$Block_18/Block_18_spr.isTarget = true

		4:
			$TimeColored.start()
			$Block_19/Block_19_spr.texture = load("res://Assests/Black.png")
			$Block_19/Block_19_spr.isTarget = true
		5:
			$TimeColored.start()
			$Block_20/Block_20_spr.texture = load("res://Assests/Black.png")
			$Block_20/Block_20_spr.isTarget = true
			

 match Row_5:
		1:
			$TimeColored.start()
			$Block_21/Block_21_spr.texture = load("res://Assests/Black.png")
			$Block_21/Block_21_spr.isTarget = true
			
		2:
			$TimeColored.start()
			$Block_22/Block_22_spr.texture = load("res://Assests/Black.png")
			$Block_22/Block_22_spr.isTarget = true
		3:
			$TimeColored.start()
			$Block_23/Block_23_spr.texture = load("res://Assests/Black.png")
			$Block_23/Block_23_spr.isTarget = true
		4:
			$TimeColored.start()
			$Block_24/Block_24_spr.texture = load("res://Assests/Black.png")
			$Block_24/Block_24_spr.isTarget = true

		5:
			$TimeColored.start()
			$Block_25/Block_25_spr.texture = load("res://Assests/Black.png")
			$Block_25/Block_25_spr.isTarget = true
...
func _input(event):
	...
	if Block_17_mouse_over and event.is_pressed() and event.button_index == BUTTON_LEFT:
		$Block_17/Block_17_spr.texture = load("res://Assests/On Click.png") 
		if $Block_17/Block_17_spr.isTarget:
			targetClicked += 1
		else:
			lives -= 1 

	if Block_18_mouse_over and event.is_pressed() and event.button_index == BUTTON_LEFT:
		$Block_18/Block_18_spr.texture = load("res://Assests/On Click.png") 
		if $Block_18/Block_18_spr.isTarget:
			targetClicked += 1
		else:
			lives -= 1 

	if Block_19_mouse_over and event.is_pressed() and event.button_index == BUTTON_LEFT:
		$Block_19/Block_19_spr.texture = load("res://Assests/On Click.png") 
		if $Block_19/Block_19_spr.isTarget:
			targetClicked += 1
		else:
			lives -= 1 

	if Block_20_mouse_over and event.is_pressed() and event.button_index == BUTTON_LEFT:
		$Block_20/Block_20_spr.texture = load("res://Assests/On Click.png") 
		if $Block_20/Block_20_spr.isTarget:
			targetClicked += 1
		else:
			lives -= 1 

	if Block_21_mouse_over and event.is_pressed() and event.button_index == BUTTON_LEFT:
		$Block_21/Block_21_spr.texture = load("res://Assests/On Click.png") 
		if $Block_21/Block_21_spr.isTarget:
			targetClicked += 1
		else:
			lives -= 1 

	if Block_22_mouse_over and event.is_pressed() and event.button_index == BUTTON_LEFT:
		$Block_22/Block_22_spr.texture = load("res://Assests/On Click.png") 
		if $Block_22/Block_22_spr.isTarget:
			targetClicked += 1
		else:
			lives -= 1 

	if Block_23_mouse_over and event.is_pressed() and event.button_index == BUTTON_LEFT:
		$Block_23/Block_23_spr.texture = load("res://Assests/On Click.png") 
		if $Block_23/Block_23_spr.isTarget:
			targetClicked += 1
		else:
			lives -= 1 

	if Block_24_mouse_over and event.is_pressed() and event.button_index == BUTTON_LEFT:
		$Block_24/Block_24_spr.texture = load("res://Assests/On Click.png") 
		if $Block_24/Block_24_spr.isTarget:
			targetClicked += 1
		else:
			lives -= 1 

	if Block_25_mouse_over and event.is_pressed() and event.button_index == BUTTON_LEFT:
		$Block_25/Block_25_spr.texture = load("res://Assests/On Click.png") 
		if $Block_25/Block_25_spr.isTarget:
			targetClicked += 1
		else:
			lives -= 1 
...
func _on_TimeColored_timeout():
	...
	$Block_17/Block_17_spr.texture = load("res://Assests/Solid color.png")
	$Block_18/Block_18_spr.texture = load("res://Assests/Solid color.png")
	$Block_19/Block_19_spr.texture = load("res://Assests/Solid color.png")
	$Block_20/Block_20_spr.texture = load("res://Assests/Solid color.png")
	$Block_21/Block_21_spr.texture = load("res://Assests/Solid color.png")
	$Block_22/Block_22_spr.texture = load("res://Assests/Solid color.png")
	$Block_23/Block_23_spr.texture = load("res://Assests/Solid color.png")
	$Block_24/Block_24_spr.texture = load("res://Assests/Solid color.png")
	$Block_25/Block_25_spr.texture = load("res://Assests/Solid color.png")
...
func _on_Block_17_mouse_entered():
	Block_17_mouse_over = true

func _on_Block_17_mouse_exited():
	Block_17_mouse_over = false

func _on_Block_18_mouse_exited():
	Block_18_mouse_over = false

func _on_Block_18_mouse_entered():
	Block_18_mouse_over = true
	
func _on_Block_19_mouse_entered():
	Block_19_mouse_over = true

func _on_Block_19_mouse_exited():
	Block_19_mouse_over = false

func _on_Block_20_mouse_exited():
	Block_20_mouse_over = false

func _on_Block_20_mouse_entered():
	Block_20_mouse_over = true

func _on_Block_21_mouse_entered():
	Block_21_mouse_over = true
	
func _on_Block_21_mouse_exited():
	Block_21_mouse_over = false

func _on_Block_22_mouse_exited():
	Block_22_mouse_over = false

func _on_Block_22_mouse_entered():
	Block_22_mouse_over = true

func _on_Block_23_mouse_entered():
	Block_23_mouse_over = true

func _on_Block_23_mouse_exited():
	Block_23_mouse_over = false

func _on_Block_24_mouse_exited():
	Block_24_mouse_over = false

func _on_Block_24_mouse_entered():
	Block_24_mouse_over = true

func _on_Block_25_mouse_entered():
	Block_25_mouse_over = true

func _on_Block_25_mouse_exited():
	Block_25_mouse_over = false
